...
// Se usan para establecer la escala de frecuencia al 20 %, que es un valor común cuando se usa este sensor de color con un Arduino 
#define S0 2
#define S1 3
// S2 y S3 controlan los fotodiodos de cada color
// Estos pines se utilizarán para seleccionar la escala de frecuencia y el color que se desea leer
#define S2 4
#define S3 5

// Out define la salida = respuesta de colores 
#define sensorColorOut 6

// https://afel.cl/products/sensor-reconocimiento-de-color-tcs230-tcs3200

//Definir pines de la pantalla
// tiene 4 pines
#define 7
#define 8
