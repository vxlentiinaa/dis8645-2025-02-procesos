...
#include <Arduino.h>
#include <Servo.h>
#include "SensorTemp.h" // Se añade la inclusión de SensorTemp.h
...
public: 
  ...
  Servo actBrazo;
  // la variable servoTemp se trasladará a ActuadorServo.cpp
  // y se manejará con una variable local o de la clase SensorTemp.
