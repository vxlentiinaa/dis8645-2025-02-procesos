...
//La tercera es SW, salida del interruptor del botón (pin 7) 

//La cuarta es DT (output B), se usa para determinar rotación (pin -3) 

//La quinta es CLK (output A), se usa para determinar cantidad de rotación 
//cada ve que el mando es girado en cualquier dirección (pin 2) 
