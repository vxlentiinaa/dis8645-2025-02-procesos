//  Millaray Millar ; Jose Morales; Josefa Quape; Francisco Stephens
//  29.08.2025
//  arduino   Uno R4
//  este codigo cumple funcion de display de haiku
//  el codigo muestra 3 imagenes y 3 texto representando un haiku que se desarrollo
...
// Constantes para calcular el tamaño del texto, imagen y lienzo

// espacio vertical entre cada objeto en pantalla
const int PADDING = 40;

// espacio estimado para el texto
const int TEXT_HEIGHT = 10;

// altura total del lienzo
const int IMAGE_HEIGHT = 65;

// altura total = 3 * texto + 3 imágenes + 4 separaciones, como esta diagramado
...
void loop() {
  ...
  // inicializar en 0
  // para la muestra de imformación
  int x = 0;
  int y = 0;
  ...
  //parametros para mostrar las imagenes, texto y espaciado
  pantallita.clearDisplay();

  //texto e imagen parrafo 0
