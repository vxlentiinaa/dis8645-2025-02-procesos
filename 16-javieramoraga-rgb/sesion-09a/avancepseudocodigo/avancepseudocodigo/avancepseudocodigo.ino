// VARIABLES GLOBALES
// Encoder
int opcionMenu = 0;    // Idioma seleccionado (0 = Ruso, 1 = Japones , etc.)
...
void loop() {
  ...
  // Cambia la selección con el encoder
  int nuevoMenu = encoder.tomarDecisiones();

  // bool dosAplausos = false;

  // bool dosAplausos = sensorSonido.leer();


  // pantallita.cambiarMenu(nuevoMenu);
